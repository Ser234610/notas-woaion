...
Envía un mensaje con `#Quiero experimentar un día WOAION` y coordinamos una sesión en el taller. Trabajarás directamente en proyectos reales de la comunidad.
...
### 🏗️ **Construir infraestructura**:

Desde cultivadores caseros hasta espacios habitacionales completos, siempre hay algo físico que construir o mejorar.
...
![Woaion580x580.png|150](/img/user/WOAION/%F0%9F%93%81%2006-RECURSOS/Woaion580x580.png)
...
Mi laboratorio no nació como un laboratorio. Empezó en una mesa o en el piso, con unos destornilladores comunes y herramientas comunes de casa,  pedasos de electrodomésticos rotos, chatarra por aqui y chatarra por alla, El junta mugre con muchas ganas y curiosidad.
...
* 🔹 Pizarra llena de ideas y esquemas que cambian todos los días. El espejo digital lo comparto en https://notas-woaion.vercel.app/coordinacion-woaion/mapa-woaion/(Centro de operaciones WOAION)
...
* **\[29/07/25]** Diseñando un Kuit de inicio para quienes se quieran unir.
